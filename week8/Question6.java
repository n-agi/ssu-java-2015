...
public class Question6 {
	...
	public static void main(String[] args) {
		...
		layout.putConstraint(SpringLayout.WEST, result, 40, SpringLayout.WEST, content);
		...
		b.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				double value = price + price * Integer.parseInt(field2.getText())/100;
				result.setText("Retail Price= "+Double.toString(value));
